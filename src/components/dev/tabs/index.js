// Index das Abas - Facilita importação em FerramentasDev.jsx

export { default as RecalculoTab } from './RecalculoTab';
export { default as DiagnosticoTab } from './DiagnosticoTab';
export { default as LimpezaTab } from './LimpezaTab';
