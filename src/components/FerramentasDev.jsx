...
function FerramentasDev() {
  ...
  const isSuperAdmin = usuario?.tipo === 'admin' && usuario?.superAdmin === true;
    ...
    <div className="ferramentas-dev-container">
      ...
      <div className="alerta-seguranca">
        ...
        <div className="alerta-conteudo">
          <strong>ATENÇÃO:</strong> Estas ferramentas podem alterar dados críticos do sistema.
      ...
      <div className="ferramentas-footer">
        <div className="footer-info">
          ...
          <span>•</span>
          <span>v{process.env.REACT_APP_VERSION || '2.3.70'}</span>
        </div>
      </div>
    </div>
  );
