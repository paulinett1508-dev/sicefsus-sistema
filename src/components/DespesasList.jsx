...
export default function DespesasList({
  ...
  return (
    <div style={styles.container}>
      ...
      {/* ✅ Seção de estatísticas gerais (só se não for filtro específico) */}
      {estatisticasGerais && !filtroInicial?.emendaId && (
        <div style={styles.statsSection}>
          <h3 style={styles.statsTitle}>
            📊 Visão Geral - Sistema de Despesas
          </h3>
          <div style={styles.statsGrid}>
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {estatisticasGerais.totalDespesas || 0}
                </span>
                <span style={styles.statLabel}>Total Despesas</span>
              </div>
            </div>
            <div style={styles.statCard}>
              <div style={styles.statIcon}>💰</div>
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {formatCurrency(estatisticasGerais.valorExecutadoGeral || 0)}
                </span>
            ...
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {estatisticasGerais.totalEmendas || 0}
                </span>
                <span style={styles.statLabel}>Emendas Envolvidas</span>
              </div>
            </div>
            <div style={styles.statCard}>
              <div style={styles.statIcon}>📈</div>
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {formatCurrency(
                    (estatisticasGerais.valorExecutadoGeral || 0) /
                      (estatisticasGerais.totalDespesas || 1),
                  )}
                </span>
                <span style={styles.statLabel}>Valor Médio</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {estatisticasFiltro && estatisticasFiltro.totalDespesas > 0 && (
        <div style={styles.statsSection}>
          <h3 style={styles.statsTitle}>
            📈 Estatísticas -{" "}
            {filtroInicial?.emendaId
          ...
          <div style={styles.statsGrid}>
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {estatisticasFiltro.totalDespesas}
                </span>
            ...
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {formatCurrency(estatisticasFiltro.valorTotalDespesas)}
                </span>
                <span style={styles.statLabel}>Valor Total</span>
              </div>
            </div>
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {formatCurrency(estatisticasFiltro.mediaValorDespesa)}
                </span>
                <span style={styles.statLabel}>Valor Médio</span>
              </div>
            </div>
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {estatisticasFiltro.emendasEnvolvidas}
                </span>
            ...
            <div style={styles.statCard}>
              ...
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {formatCurrency(estatisticasFiltro.maiorDespesa)}
                </span>
                <span style={styles.statLabel}>Maior Despesa</span>
              </div>
            </div>
            <div style={styles.statCard}>
              <div style={styles.statIcon}>⬇️</div>
              <div style={styles.statContent}>
                <span style={styles.statValue}>
                  {formatCurrency(estatisticasFiltro.menorDespesa)}
                </span>
                <span style={styles.statLabel}>Menor Despesa</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ✅ Distribuição por natureza (se houver variedade) */}
      {estatisticasFiltro &&
        Object.keys(estatisticasFiltro.despesasPorNatureza).length > 1 && (
          <div style={styles.distributionSection}>
            <h4 style={styles.distributionTitle}>
              📋 Distribuição por Natureza da Despesa
            </h4>
            <div style={styles.distributionGrid}>
              {Object.entries(estatisticasFiltro.despesasPorNatureza).map(
                ([natureza, count]) => (
                  <div key={natureza} style={styles.distributionItem}>
                    <span style={styles.distributionCount}>{count}</span>
                    <span style={styles.distributionLabel}>
                      {natureza.length > 30
                        ? natureza.substring(0, 30) + "..."
                        : natureza}
                    </span>
                  </div>
                ),
      ...
      {estatisticasFiltro &&
        Object.keys(estatisticasFiltro.despesasPorFornecedor).length > 1 && (
          <div style={styles.distributionSection}>
            <h4 style={styles.distributionTitle}>🏢 Top Fornecedores</h4>
            <div style={styles.distributionGrid}>
              {Object.entries(estatisticasFiltro.despesasPorFornecedor)
                .sort(([, a], [, b]) => b - a)
                .slice(0, 8)
                .map(([fornecedor, count]) => (
                  <div key={fornecedor} style={styles.distributionItem}>
                    <span style={styles.distributionCount}>{count}</span>
                    <span style={styles.distributionLabel}>
