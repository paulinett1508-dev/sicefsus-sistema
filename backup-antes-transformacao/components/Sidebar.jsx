...
const menuItems = [
  ...
  { label: "Despesas", icon: "💸", path: "/lancamentos" },
  { label: "Relatórios", icon: "📈", path: "/relatorios" },
  { label: "Sobre", icon: "ℹ️", path: "/sobre" }, // ✅ ADICIONADO
];

const adminItems = [{ label: "Administração", icon: "⚙️", path: "/admin" }];
...
export default function Sidebar({ onNavigate, activePath, usuario, onLogout }) {
  ...
  const handleSearchResultSelect = (result) => {
    // Callback quando um resultado é selecionado
