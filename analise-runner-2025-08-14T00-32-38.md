...
- **📁 Total de Diretórios:** 24
- **📄 Total de Arquivos:** 166
- **📈 Tipos de Arquivo:** 12
...
├── 📄 `.replit` *(61 linhas)*
│     - 📄 Arquivo
├── 📄 `HANDOVER_SICEFSUS.md` *(875 linhas)*
...
│         - 💻 JavaScript
├── 📁 **attached_assets/**
│   ├── 📄 `Pasted--CORRE-ES-UNIVERSAIS-Administracao-jsx-Funcionam-em-DEV-HOMOLOG-PROD-CORRE--1755050632312_1755050632313.txt` *(298 linhas)*
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--CORRE-O-GRANULAR-em-src-components-DespesaForm-jsx-MELHORAR-a-valida-o-existente-linh-1755043845075_1755043845075.txt` *(63 linhas)*
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--MUDAN-AS-GRANULARES-em-src-components-DespesaForm-jsx-ADICIONAR-Auto-carregamento-de-dado-1755047265988_1755047265988.txt` *(181 linhas)*
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--MUDAN-AS-GRANULARES-em-src-components-Login-jsx-ADICIONAR-no-topo-dos-imports-import--1755042142157_1755042142157.txt` *(283 linhas)*
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--MUDAN-AS-GRANULARES-em-src-components-UserForm-jsx-ADICIONAR-import-do-contexto-do-usu-r-1755042039558_1755042039558.txt` *(213 linhas)*
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--MUDAN-AS-GRANULARES-em-src-components-emenda-EmendaForm-sections-Cronograma-jsx-ADICIONA-1755045094552_1755045094553.txt` *(245 linhas)*
│   │     - 📄 Arquivo
│   └── 📄 `image_1755049611694.png` *(94 linhas)*
│         - 🖼️ Imagem PNG
...
│   │   │   │     - 🧩 Componente React
│   │   │   ├── 📄 `UsersSection.jsx` *(88 linhas)*
│   │   │   │     - 🧩 Componente React
│   │   │   └── 📄 `UsersTable.jsx` *(211 linhas)*
│   │   │         - 🧩 Componente React
│   │   ├── 📁 **despesa/**
...
- **Extensão mais comum:** .jsx (86 arquivos)
