...
├── README.md (842 bytes)
├── analise-runner-2025-08-14T22-56-09.md (20.6 KB)
├── analise-runner-2025-08-15T22-48-01.md (23.0 KB)
├── analise-runner-2025-08-18T18-49-24.md (20.9 KB)
├── api/
│   ├── package-lock.json (30.1 KB)
│   ├── package.json (351 bytes)
│   ├── routes/
│   │   └── users.js (0 bytes)
│   └── server.js (9.1 KB)
├── firebase.json (0 bytes)
├── functions/
│   ├── index.js (0 bytes)
│   └── package.json (0 bytes)
├── generate-version.js (2.5 KB)
├── package-lock.json (309.7 KB)
├── package.json (1.7 KB)
├── public/
...
│   │   ├── Administracao.jsx (18.2 KB)
│   │   ├── CNPJInput.jsx (6.9 KB)
│   │   ├── CNPJTester.jsx (3.4 KB)
│   │   ├── ConfirmationModal.jsx (4.1 KB)
...
│   │   ├── DebugUsuarios.jsx (9.0 KB)
│   │   ├── DespesaForm.jsx (27.6 KB)
│   │   ├── Despesas.jsx (17.4 KB)
│   │   ├── DespesasFilters.jsx (7.6 KB)
│   │   ├── DespesasList.jsx (8.9 KB)
...
│   │   ├── TesteUsuarios.jsx (5.2 KB)
│   │   ├── ThemeToggle.jsx (40 bytes)
│   │   ├── Toast.jsx (5.5 KB)
│   │   ├── UpdateNotification.jsx (4.5 KB)
│   │   ├── UserForm.jsx (36.3 KB)
│   │   ├── UsersTable.jsx (10.3 KB)
│   │   ├── VisualizacaoEmendaDespesas.jsx (34.9 KB)
│   │   ├── WorkflowManager.jsx (16.8 KB)
│   │   ├── admin/
│   │   │   ├── AdminHeader.jsx (2.0 KB)
│   │   │   ├── AdminTabs.jsx (1.4 KB)
│   │   │   ├── LogsSection.jsx (10.1 KB)
│   │   │   ├── UserModal.jsx (999 bytes)
│   │   │   ├── UsersSection.jsx (2.0 KB)
│   │   │   └── UsersTable.jsx (7.2 KB)
│   │   ├── despesa/
...
│   │   │   ├── DespesaFormDateFields.jsx (12.3 KB)
...
- **Descrição:** src/components/Administracao.jsx - VERSÃO REFATORADA E LIMPA
- **Tamanho:** 18.2 KB
- **Exports:** default
...
#### `src/components/DebugUsuarios.jsx`
- **Descrição:** Sem descrição
- **Tamanho:** 9.0 KB
- **Exports:** default
...
#### `src/components/TesteUsuarios.jsx`
- **Descrição:** Sem descrição
- **Tamanho:** 5.2 KB
- **Exports:** default
...
- **Descrição:** src/components/admin/AdminHeader.jsx
- **Tamanho:** 2.0 KB
- **Exports:** default

#### `src/components/admin/AdminTabs.jsx`
- **Descrição:** src/components/admin/AdminTabs.jsx
- **Tamanho:** 1.4 KB
- **Exports:** default

#### `src/components/admin/LogsSection.jsx`
- **Descrição:** src/components/admin/LogsSection.jsx
- **Tamanho:** 10.1 KB
- **Exports:** default

#### `src/components/admin/UserModal.jsx`
- **Descrição:** src/components/admin/UserModal.jsx
- **Tamanho:** 999 bytes
- **Exports:** default

#### `src/components/admin/UsersSection.jsx`
- **Descrição:** src/components/admin/UsersSection.jsx
- **Tamanho:** 2.0 KB
- **Exports:** default

#### `src/components/admin/UsersTable.jsx`
- **Descrição:** src/components/admin/UsersTable.jsx - VERSÃO CORRIGIDA COMPLETA
- **Tamanho:** 7.2 KB
- **Exports:** default
...
- **Descrição:** src/services/userService.js - VERSÃO CORRIGIDA
- **Tamanho:** 13.2 KB
...
### firebase.json
- **Propósito:** Configuração do Firebase
- **Tamanho:** 0 bytes
- **Modificado:** 14/08/2025
...
- `src/utils/versionControl.js` (Utilitário) - 15/08/2025
- `src/services/userService.js` (Serviço) - 15/08/2025
- `src/components/DespesaForm.jsx` (Componente) - 15/08/2025
- `src/components/Despesas.jsx` (Componente) - 15/08/2025
- `src/components/DespesasList.jsx` (Componente) - 15/08/2025
- `src/components/ConfirmationModal.jsx` (Componente) - 15/08/2025
- `src/components/Administracao.jsx` (Componente) - 15/08/2025
- `src/components/admin/UsersTable.jsx` (Componente) - 15/08/2025
- `src/components/emenda/EmendaForm/sections/Identificacao.jsx` (Componente) - 14/08/2025
- `src/components/admin/UsersSection.jsx` (Componente) - 14/08/2025
- `src/components/TesteUsuarios.jsx` (Componente) - 14/08/2025
- `src/components/DebugUsuarios.jsx` (Componente) - 14/08/2025
- `src/components/admin/LogsSection.jsx` (Componente) - 13/08/2025
- `src/components/admin/UserModal.jsx` (Componente) - 13/08/2025
- `src/components/admin/AdminTabs.jsx` (Componente) - 13/08/2025
- `src/components/admin/AdminHeader.jsx` (Componente) - 13/08/2025
- `src/components/UserForm.jsx` (Componente) - 13/08/2025
- `src/components/despesa/DespesaFormDateFields.jsx` (Componente) - 13/08/2025
- `src/components/emenda/EmendaForm/sections/Cronograma.jsx` (Componente) - 13/08/2025
- `src/components/Login.jsx` (Componente) - 12/08/2025
- `src/utils/validators.js` (Utilitário) - 12/08/2025
...
- **Total de Serviços:** 4
- **Arquivos Importantes:** 5
- **Mudanças Recentes:** 21
