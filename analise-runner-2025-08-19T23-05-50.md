...
- **📁 Total de Diretórios:** 27
- **📄 Total de Arquivos:** 182
- **📈 Tipos de Arquivo:** 13
...
├── 📄 `analise-runner-2025-08-19T20-01-43.md` *(502 linhas)*
│     - 📖 Documentação Markdown
├── 📁 **api/**
...
│         - 💻 JavaScript
├── 📁 **attached_assets/**
│   ├── 📄 `Pasted--ADICIONAR-AP-S-A-LTIMA-FUN-O-VALIDAR-cronograma-completo-da-emenda-param-Ob-1755610699824_1755610699825.txt` *(117 linhas)*
│   │     - 📄 Arquivo
...
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--ERRO-CR-TICO-IDENTIFICADO-require-n-o-definido-O-erro-claro-estou-usando-require-em-ambient-1755612419314_1755612419316.txt` *(70 linhas)*
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--GUIA-FINAL--1755642658385_1755642658385.txt` *(312 linhas)*
│   │     - 📄 Arquivo
│   ├── 📄 `Pasted--IMPLEMENTA-O-UX-Bot-o-Inteligente-Voltar-vs-Cancelar-CORRE-O-1-index-jsx-Detectar-mo-1755626003480_1755626003481.txt` *(207 linhas)*
│   │     - 📄 Arquivo
...
│         - 📄 Arquivo
├── 📄 `backup_original.jsx` *(1766 linhas)*
│     - ⚛️ Componente React
...
│   │   │   │   │         - 🧩 Componente React
│   │   │   │   ├── 📄 `index.jsx` *(351 linhas)*
│   │   │   │   │     - 🧩 Componente React
│   │   │   │   └── 📁 **sections/**
│   │   │   │       ├── 📄 `AcoesServicos.jsx` *(576 linhas)*
│   │   │   │       │     - 🧩 Componente React
│   │   │   │       ├── 📄 `ClassificacaoTecnica.jsx` *(216 linhas)*
│   │   │   │       │     - 🧩 Componente React
│   │   │   │       ├── 📄 `Cronograma.jsx` *(534 linhas)*
│   │   │   │       │     - 🧩 Componente React
│   │   │   │       ├── 📄 `DadosBancarios.jsx` *(294 linhas)*
│   │   │   │       │     - 🧩 Componente React
│   │   │   │       ├── 📄 `DadosBasicos.jsx` *(324 linhas)*
│   │   │   │       │     - 🧩 Componente React
│   │   │   │       ├── 📄 `DadosBeneficiario.jsx` *(517 linhas)*
│   │   │   │       │     - 🧩 Componente React
│   │   │   │       ├── 📄 `Identificacao.jsx` *(347 linhas)*
│   │   │   │       │     - 🧩 Componente React
...
│   │   │     - 🎣 Hook React
│   │   ├── 📄 `useEmendaFormData.js` *(943 linhas)*
│   │   │     - 🎣 Hook React
...
- **Extensão mais comum:** .jsx (93 arquivos)
